...
model = AutoModelForCausalLM.from_pretrained(args.save_dir, torch_dtype="auto")
...
log_metrics(0000, {"loss/eval": eval_loss, "perplexity": perplexity})
accelerator.wait_for_everyone()
save_dir = os.path.join(args.save_dir, f"step_{0000}")
